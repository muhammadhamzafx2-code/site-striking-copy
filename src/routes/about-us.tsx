...
export const Route = createFileRoute("/about-us")({
  head: () => ({
    meta: [
      { title: "About XMV — Our Mission" },
      { name: "description", content: "Learn about XMV: a global crypto exchange built on security, transparency and community." },
    ],
  }),
  component: AboutPage,
});
...
function AboutPage() {
  return (
    <>
      <PageHeader title="About XMV" subtitle="Our mission is to make digital assets accessible to everyone." />
      <section className="container mx-auto px-4 py-12 max-w-3xl space-y-6 text-muted-foreground leading-relaxed">
        <p>XMV is a global cryptocurrency exchange serving 39 million customers across 200+ countries. We provide a secure, fast and transparent gateway into the digital economy — for first-time buyers and professional traders alike.</p>
