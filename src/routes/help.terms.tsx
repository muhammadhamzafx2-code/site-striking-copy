...
export const Route = createFileRoute("/help/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service | Exonax" },
      { name: "description", content: "Read the Exonax terms of service and user agreement." },
    ],
  }),
  component: TermsPage,
});
      ...
      <section className="container mx-auto px-4 py-12 max-w-3xl space-y-6 text-muted-foreground leading-relaxed">
        {["Acceptance of Terms", "Account Registration", "Eligibility", "Trading Rules", "Fees", "Risk Disclosure", "Privacy", "Limitation of Liability"].map((s, i) => (
          <div key={s}>
            ...
            <p className="mt-2">By using Exonax, you agree to comply with all applicable laws and platform rules. Crypto trading involves substantial risk; you should only trade with funds you can afford to lose.</p>
          </div>
        ))}
      </section>
    </>
